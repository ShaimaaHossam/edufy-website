...
import { useState, useEffect } from "react";
 ...
 function SignUp() {
  ...
  const signUp = async () => {
    try {
      const res = await axios.post('http://edufy-backend.jjdu4f46bt-xlm41rjo56dy.p.runcloud.link/api/user/register', {name: username ,email: registerEmail, password: registerPassword})
      if(res.status == 200){
