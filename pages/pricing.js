    ...
    <div className="pb-20 bg-gray-800 px-6 md:px-12">
      <div className="w-full text-center  py-20  ">
        ...
        <p className="text-2xl font-medium text-gray-300 mt-2">
          Choose the right plan for you, and make the most of our service!
        </p>
      </div>
        ...
        <div className="rounded-lg shadow-lg overflow-hidden mb-4">
          <div className="px-6 py-8 bg-gray-600 sm:p-10 sm:pb-6">
            ...
            <div className="mt-4 flex justify-center text-6xl leading-none font-extrabold text-white">
              $10
              <span className="ml-1 pt-8 text-2xl leading-8 font-medium  text-white">
                /month
              </span>
            </div>
          </div>
          <div className="px-6 pt-6 pb-8 bg-gray-700 sm:p-10 sm:pt-6">
            <ul>
