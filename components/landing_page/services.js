export default function Services(){
    return(
        <div className="px-8 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-5  bottom-0" >
        <h1 className="text-2xl  font-bold mb-16 text-gray-800">Our Features</h1>
        <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
            ...
            <div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
                ...
                <p className="text-lg md:text-xl font-medium text-slate-700 mt-3">Realtime Update</p>
                <p className="mt-2 text-sm text-slate-500">Lecturers are continuously updated with their attendees status</p>
            </div>
