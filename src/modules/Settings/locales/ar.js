const ar = {
  ...
  notificationsSummary: " ملخص الاشعارت",
  summaryLabel:
    "يمكنك تخصيص الإخطارات الواردة أدناه. يجب أن يحتوي كل إخطار مدرج على إشعارات البريد الإلكتروني أو الرسائل القصيرة أو التطبيق على الأقل واحده ",
  summary: "الملخص",
  email: "البريد",
  sms: "الرسائل ",
  app: "التطبيق",
