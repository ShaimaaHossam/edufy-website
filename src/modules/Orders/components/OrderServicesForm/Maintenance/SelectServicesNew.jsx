...
const SelectSerivcesNew = () => {
  ...
  const { data: allServices = [] } = useGetCompanyServicesTreeQuery(undefined);
                                    ...
                                    <Grid item xs={6}>
                                      ...
                                      >
                                        ...
                                        <Typography
                                          ...
                                          variant="subtitle2"
                                        >
                                          All Services prices are Vat inclusive.
                                        </Typography>
                                      </Box>
                                    </Grid>
                                    <Grid item xs={2}>
...
export default SelectSerivcesNew;
